...
message("Loading species model input directories\n")
...
message("Loading species model output directories","\n")
...
#message("Loading dirs for validation process")
